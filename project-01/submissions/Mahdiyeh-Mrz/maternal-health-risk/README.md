...
- 1,014 observations in the supplied project CSV; after removing 2 physiologically implausible `HeartRate = 7` records, the final analysis dataset contains **1,012 observations**.
...
|---|---|
| Missing values | 0 |
| Exact duplicate rows | 562 / 1,014 (55.4%) of supplied raw observations |
...
└── data/
    ├── Maternal_Health_Risk_Data_Set.csv       # final cleaned 1,012-row analysis data
    ├── Maternal_Health_Risk_Data_Set_raw_1014.csv # supplied raw 1,014-row export
